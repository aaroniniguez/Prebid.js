...
function registerEidSignalSources(encrypt, timeout) {
...
function registerCustomSignalSources(signalSourceToCustomFunc) {
  if (!utils.isGptPubadsDefined()) {
    return;
  }
	window.googletag.encryptedSignalProviders = window.googletag.encryptedSignalProviders || [];
...
export function init(config) {
  ...
  (getGlobal()).registerEidSignalSources = registerEidSignalSources;
